        ...
        {digestExpanded && (
          <div className="mt-6 space-y-4">
            <div className="grid grid-cols-2 sm:grid-cols-4 gap-3">
              <Link href="/dashboard/appointments" onClick={(e) => e.stopPropagation()} className="bg-dark-bg/50 rounded-lg p-3 text-center hover:bg-dark-bg/80 transition-colors"><p className="text-2xl font-bold text-white">{stats.todayAppointments}</p><p className="text-xs text-gray-400">Today's Appts</p></Link>
