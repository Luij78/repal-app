      ...
      <div className="card bg-gradient-to-br from-dark-card to-dark-bg border-primary-500/30 cursor-pointer" onClick={() => setDigestExpanded(!digestExpanded)}>
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <div><h2 className="font-playfair text-lg text-primary-400">AI Daily Digest</h2><p className="text-sm text-gray-400">{getGreeting()}, {user?.firstName || 'Agent'}! Here's your daily briefing.</p></div>
          </div>
